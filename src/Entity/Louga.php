...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\LougaRepository")
 */
class Louga
{
    /**
     ...
     * @var string|null
     *
     * @ORM\Column(name="Collectivite", type="string", length=18, nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lieudevote", type="string", length=37, nullable=true)
     */
    private $lieudevote;
