...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\KedougouRepository")
 */
class Kedougou
{
    /**
     ...
     * @var string|null
     *
     * @ORM\Column(name="Departement", type="string", length=8, nullable=true)
     */
    private $departement;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Collectivite", type="string", length=17, nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lieudevote", type="string", length=28, nullable=true)
     */
    private $lieudevote;
