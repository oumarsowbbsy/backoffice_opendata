...
/**
 * @ApiResource()
 * @ORM\Entity(repositoryClass="App\Repository\DiasporaRepository")
 */
class Diaspora
{
    /**
     ...
     * @var string|null
     *
     * @ORM\Column(name="Departement", type="string", length=21, nullable=true)
     */
    private $departement;
     ...
     * @var string|null
     *
     * @ORM\Column(name="Collectivite", type="string", length=25, nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="Lieudevote", type="string", length=32, nullable=true)
     */
    private $lieudevote;
